...
export function Jogo() {
  ...
  return (
    <div className="flex h-screen w-full flex-col overflow-hidden p-2 lg:grid lg:grid-cols-[1fr_300px] lg:gap-3 lg:p-3">
      ...
      <div className="order-2 flex min-h-0 flex-1 flex-col items-center justify-center lg:order-1">
        <div className="relative h-full w-full max-h-[calc(100vh-120px)] lg:max-h-[calc(100vh-24px)]">
          <Board
            jogadores={jogadores}
            donos={donos}
            atual={atual}
